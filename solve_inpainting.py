...
if __name__ == "__main__":
    ...
    parser.add_argument('-gamma',  type=float, nargs='+',help='regularizor',default=[0,0.01,0.1,0.5])
    parser.add_argument('-alpha', type=float, nargs='+',help='red multiplier', default=[0.01,0.1,0.5])
    parser.add_argument('-beta', type=float, nargs='+',help='consistency multiplier', default=[0.01,0.1,0.5])
